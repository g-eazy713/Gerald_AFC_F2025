...
const allExtraProperties = require("cssstyle/lib/allExtraProperties");
const allProperties = require("cssstyle/lib/generated/allProperties");
const implementedProperties = require("cssstyle/lib/generated/implementedProperties");
const generatedProperties = require("cssstyle/lib/generated/properties");
const { hasVarFunc, parseKeyword, parseShorthand, prepareValue, splitValue } = require("cssstyle/lib/parsers");
...
const { asciiLowercase } = require("cssstyle/lib/utils/strings");
