...
exports.Parse = Parse;
const Guard = __importStar(require("@sinclair/typebox/build/cjs/parser/runtime/guard"));
const Token = __importStar(require("@sinclair/typebox/build/cjs/parser/runtime/token"));
// ------------------------------------------------------------------
// Context
// ------------------------------------------------------------------
