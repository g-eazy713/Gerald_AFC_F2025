...
const index_1 = require("@sinclair/typebox/build/cjs/type/symbols");
const index_2 = require("@sinclair/typebox/build/cjs/type/discard");
// evaluation types
const index_3 = require("@sinclair/typebox/build/cjs/type/array");
const index_4 = require("@sinclair/typebox/build/cjs/type/async-iterator");
const index_5 = require("@sinclair/typebox/build/cjs/type/constructor");
const index_6 = require("@sinclair/typebox/build/cjs/type/function");
const index_7 = require("@sinclair/typebox/build/cjs/type/indexed");
const index_8 = require("@sinclair/typebox/build/cjs/type/intersect");
const index_9 = require("@sinclair/typebox/build/cjs/type/iterator");
const index_10 = require("@sinclair/typebox/build/cjs/type/literal");
const index_11 = require("@sinclair/typebox/build/cjs/type/object");
const index_12 = require("@sinclair/typebox/build/cjs/type/optional");
const index_13 = require("@sinclair/typebox/build/cjs/type/promise");
const index_14 = require("@sinclair/typebox/build/cjs/type/readonly");
const index_15 = require("@sinclair/typebox/build/cjs/type/tuple");
const index_16 = require("@sinclair/typebox/build/cjs/type/union");
// operator
const index_17 = require("@sinclair/typebox/build/cjs/type/sets");
// mapping types
const mapped_result_1 = require("@sinclair/typebox/build/cjs/type/mapped/mapped-result");
// ------------------------------------------------------------------
// TypeGuard
// ------------------------------------------------------------------
const kind_1 = require("@sinclair/typebox/build/cjs/type/guard/kind");
// prettier-ignore
