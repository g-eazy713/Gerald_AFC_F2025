import { JsonTypeBuilder } from '@sinclair/typebox/build/esm/type/type/json.js';
...
import { type TBigInt, type BigIntOptions } from '@sinclair/typebox/build/esm/type/bigint';
import { type TConstructor } from '@sinclair/typebox/build/esm/type/constructor';
import { type TConstructorParameters } from '@sinclair/typebox/build/esm/type/constructor-parameters';
import { type TDate, type DateOptions } from '@sinclair/typebox/build/esm/type/date';
import { type TFunction } from '@sinclair/typebox/build/esm/type/function';
import { type TInstanceType } from '@sinclair/typebox/build/esm/type/instance-type';
import { type TInstantiate } from '@sinclair/typebox/build/esm/type/instantiate';
import { type TIterator } from '@sinclair/typebox/build/esm/type/iterator';
import { type TParameters } from '@sinclair/typebox/build/esm/type/parameters';
import { type TPromise } from '@sinclair/typebox/build/esm/type/promise';
import { type TRegExp, RegExpOptions } from '@sinclair/typebox/build/esm/type/regexp';
import { type TReturnType } from '@sinclair/typebox/build/esm/type/return-type';
...
import { type TUint8Array, type Uint8ArrayOptions } from '@sinclair/typebox/build/esm/type/uint8array';
