...
import { TemplateLiteral, TemplateLiteralParseExact, IsTemplateLiteralExpressionFinite, TemplateLiteralExpressionGenerate } from '@sinclair/typebox/build/esm/type/template-literal/index.mjs';
import { IntrinsicFromMappedKey } from '@sinclair/typebox/build/esm/type/intrinsic/intrinsic-from-mapped-key.mjs';
...
// TypeGuard
// ------------------------------------------------------------------
import { IsMappedKey, IsTemplateLiteral, IsUnion, IsLiteral } from '@sinclair/typebox/build/esm/type/guard/kind.mjs';
// ------------------------------------------------------------------
// Apply
// ------------------------------------------------------------------
