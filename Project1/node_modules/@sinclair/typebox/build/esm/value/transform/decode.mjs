import { TypeSystemPolicy } from '@sinclair/typebox/build/esm/system/policy.mjs';
import { Kind, TransformKind } from '@sinclair/typebox/build/esm/type/symbols/index.mjs';
import { TypeBoxError } from '@sinclair/typebox/build/esm/type/error/index.mjs';
import { KeyOfPropertyKeys, KeyOfPropertyEntries } from '@sinclair/typebox/build/esm/type/keyof/index.mjs';
...
// ValueGuard
// ------------------------------------------------------------------
import { HasPropertyKey, IsObject, IsArray, IsValueType, IsUndefined as IsUndefinedValue } from '@sinclair/typebox/build/esm/value/guard/index.mjs';
// ------------------------------------------------------------------
// KindGuard
// ------------------------------------------------------------------
import { IsTransform, IsSchema, IsUndefined } from '@sinclair/typebox/build/esm/type/guard/kind.mjs';
// ------------------------------------------------------------------
// Errors
// ------------------------------------------------------------------
// thrown externally
